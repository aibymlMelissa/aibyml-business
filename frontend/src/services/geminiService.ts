...
import type { GenerateContentResponse, Tool, Content } from "@google/genai";
import type { UrlContextMetadataItem } from '../types/chatbot';

// IMPORTANT: The API key MUST be set as an environment variable `VITE_GEMINI_API_KEY`
